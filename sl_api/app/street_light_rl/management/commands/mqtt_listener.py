...
def on_message(client, userdata, msg):
    ...
    grid_id = uuid.UUID(message_object['grid_id']) # Getting grid id and converting to a uuid object.
...
def get_width_and_height(grid):
    ...
    filtered_messages = messages.filter(grid=grid) # Filtering messages that belong to specific grid.
